...
[!\[Streamlit App](https://static.streamlit.io/badges/streamlit\_badge\_black\_white.svg)](https://sentinel-ayushee.streamlit.app)

(https://sentinel-ayushee.streamlit.app)
...
```
generate\_data.py   →  Synthetic dataset (1,200 student profiles, ground-truth logistic model)
...
train\_model.py     →  One-time training script
```
...
* **Sampler:** NUTS, 2 chains × 1000 draws (+ 1000 tune), target\_accept=0.9
